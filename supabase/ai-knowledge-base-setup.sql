...
CREATE TABLE IF NOT EXISTS ai_knowledge_articles (
  ...
  category TEXT NOT NULL CHECK (category IN ('property', 'pricing', 'policy', 'faq', 'location', 'amenity', 'process', 'custom')),
  title TEXT NOT NULL,
  content TEXT NOT NULL,
  tags TEXT[] DEFAULT '{}',
  source TEXT DEFAULT 'manual' CHECK (source IN ('manual', 'website-sync', 'conversation-suggested')),
  source_url TEXT,
