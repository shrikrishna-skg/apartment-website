...
const applicantTypes = [
  {
    ...
    documents: [
      ...
      "Previous rental history (if any)",
    ],
  },
  {
    id: "international",
    ...
    documents: [
      "Valid passport",
      "Student visa (F-1 or J-1) documentation",
      "I-20 or DS-2019 form",
      "Proof of enrollment or acceptance letter",
      "Bank statement or financial guarantee",
      "Emergency contact (domestic and international)",
      "Co-signer information (U.S.-based preferred)",
    ],
  },
  {
    id: "professional",
